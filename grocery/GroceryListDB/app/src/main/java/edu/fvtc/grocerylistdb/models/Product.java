...
public class Product implements Serializable {
    ...
    public Product(int id, String productDescription, boolean isOnShoppingList, boolean isInCart, String owner, Double latitude , Double longitude ) {
        this.id = id;
        this.productDescription = productDescription;
        this.isOnShoppingList = isOnShoppingList;
        this.isInCart = isInCart;
    ...
    public String toString() {
        return  id + "|" + productDescription + "|" + isOnShoppingList + "|" + isInCart +"|"+owner+"|"+latitude+"|"+ longitude;
    }
}
